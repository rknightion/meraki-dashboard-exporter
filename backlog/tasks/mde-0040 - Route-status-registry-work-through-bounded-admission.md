...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Status registry work uses the existing bounded registry admission mechanism
- [ ] #2 Saturated status requests return the established 503 and Retry-After contract
- [ ] #3 Tests cover blocked registry work and cancellation
<!-- AC:END -->
