...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Authorization is preserved for same-origin requests including equivalent explicit default ports
- [x] #2 Authorization is stripped for every cross-origin request, including another Meraki-owned host
- [x] #3 Lookalike hosts and scheme or port changes are covered by regression tests
- [x] #4 The implementation and docs agree with frozen decision D9
<!-- AC:END -->
