...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Distinct label mappings cannot collide because of label-value delimiters in the expiration manager internal key
- [x] #2 Two deliberately colliding legacy encodings remain independently tracked, expired and removed
- [x] #3 Existing TTL cleanup and cardinality-shedding behavior remains unchanged
<!-- AC:END -->
