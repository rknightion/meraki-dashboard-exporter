...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 ast-serialize 0.9.0 release contents and compatibility risk are established from authoritative package artifacts or direct behavior
- [x] #2 Mypy and repository type-check behavior are compared on 0.8.0 and 0.9.0, including cache creation and reuse
- [x] #3 The lock update is accepted only if the focused comparison and the full repository gate pass
<!-- AC:END -->
