...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 All four shared task-admission metrics appear in the generated metric reference with correct types and the phase label
- [ ] #2 The reference explains the collector_admission and task_group phase values without implying endpoint failure
- [ ] #3 Generator regression coverage and make docgen pass without unrelated drift
<!-- AC:END -->
