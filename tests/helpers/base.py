...
class BaseCollectorTest:
    ...
    def isolated_registry(self, monkeypatch: pytest.MonkeyPatch) -> CollectorRegistry:
        ...
        monkeypatch.setattr(
            "meraki_dashboard_exporter.core.collector.REGISTRY",
            registry
        )
        return registry
    ...
    def setup_standard_test_data(
        ...
        """
        from .factories import OrganizationFactory, NetworkFactory, DeviceFactory
        ...
        for org in orgs:
            ...
            networks = NetworkFactory.create_many(
                network_count,
                org_id=org["id"]
            )
            ...
            for network in networks:
                devices = DeviceFactory.create_mixed(
                    device_count,
