...
class CollectorSettings(BaseModel):
    ...
    profile: Literal["availability", "standard", "full"] | None = Field(
        ...
        description=(
            ...
            "priorities. When unset, the full surface is preserved if the solved full-plan "
            "demand fits the adaptive scheduler's budget target; above that threshold, startup "
            "requires an explicit profile choice. Fixed scheduler mode does not apply this gate."
        ),
    )
