...
class MetricName(StrEnum):
    ...
    ORG_LOGIN_SECURITY_PASSWORD_EXPIRATION_ENABLED = "meraki_org_login_security_password_expiration_enabled"
    ORG_LOGIN_SECURITY_PASSWORD_EXPIRATION_DAYS = "meraki_org_login_security_password_expiration_days"
    ORG_LOGIN_SECURITY_DIFFERENT_PASSWORDS_ENABLED = "meraki_org_login_security_different_passwords_enabled"
    ORG_LOGIN_SECURITY_DIFFERENT_PASSWORDS_COUNT = "meraki_org_login_security_different_passwords_count"
